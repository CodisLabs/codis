...
\begin{tikzpicture}[x=1pt,y=1pt,auto]
    ...
    \tikzstyle{dashboard}=[minimum width=100]
    {
        ...
        \node[draw=gray,minimum width=130,minimum height=70,rounded corners=0] (box) at (580, -120) {};
        \node[server] (s0) at (570, -100) {\small{codis-server:0}};
        \node[server] (s1) at (570, -120) {\small{codis-server:1}};
        \node[server] (s2) at (570, -140) {\small{codis-server:2}};
        ...
        \node[draw,cloud,cloud puffs=9,minimum width=100pt,minimum height=60pt] (cloud1) at (580, 90) {};
        \node[note] at (580,90) {Storage};
