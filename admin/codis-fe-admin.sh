...
COORDINATOR_NAME="db"
COORDINATOR_ADDR="root:1@tcp(127.0.0.1:3306)/codis?charset=utf8"
CODIS_FE_ADDR="192.168.126.149:9090"
...
start)
    ...
    "--log=$CODIS_FE_LOG_FILE" "--log-level=INFO" "--pidfile=$CODIS_FE_PID_FILE" "--listen=$CODIS_FE_ADDR" > "$CODIS_FE_DAEMON_FILE" 2>&1 < /dev/null & 
    ;;
start-foreground)
